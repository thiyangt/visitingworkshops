...
subtitle: "Lecture 3: Simple Linear Regression (cont.)"
...
$$e_i = \text{True value} - \text{Fitted value}$$
...
> Residuals measure the variability in the **response variable** not explained by the regression model.
---
background-image: url('variation.PNG')
...
$SS_R$ - Explained variation attributable to factors other than the relationship between $x$ and $y$.

$SS_{Res}$ - A measure of the variability in $y$ remaining after $x$ has been considered.
