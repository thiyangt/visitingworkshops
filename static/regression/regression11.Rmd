...
- Sometimes indicator variables are calle **dummy variable.**
...
.pull-left[
```{r, comment=NA, message=FALSE, echo=FALSE}
data <- data.frame(IQ=c(10, 20, 100, 98, 100, 11, 50, 70), Gender = c("Normal", "Normal", "Obese", "Obese", "Underweight", "Underweight", 
  "Underweight", "Underweight"), BMI = c(20.2, 20.5, 18.5, 25, 24.9, 31, 18.5, 20),
